...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pub_tag = n.advertise<std_msgs::Int8>("/tag", 10);
    ...
    double  X =  X_pos/1000;
    double Y = Y_pos/1000;
    double Ang=2*3.14159-Angle*3.14159/180;       
    //将欧拉角转换成四元数
